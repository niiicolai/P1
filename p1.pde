...
void setup () {
  ...
  println("Since the implementation of voice activation programs such as Siri, your phone needs to be listening all the time for the activation phrase. Therefore, you sometimes experience targeted ads about things you have only talked about. ".length());
  ...
  int frontPageFontSize = 70;
  PVector bigTitlePosition = new PVector(0, 50);
  PVector bigTitleSize = new PVector(width-150, 60);
  
  PVector smallTitlePosition = new PVector(200, 50);
  PVector smallTitleSize = new PVector(width-400, 60);
  
  PVector bigTextBoxPosition = new PVector(50, 160);
  PVector bigTextBoxSize = new PVector(width-250, height-200);
  
  PVector smallTextBoxPosition = new PVector(200, 160);
